...
import { Search, Plus, Lightbulb, Edit, Book, ArrowUpRight, Trash2, Sparkles } from "lucide-react";
...
const KnowledgeBase = () => {
  ...
  const { articles, isLoading, error, createArticle, updateArticle, deleteArticle } = useKnowledgeArticles(
    searchType === "traditional" ? debouncedSearch : undefined
  );
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      {/* Only show article filters and list for traditional search */}
