      ...
      <div className="h-full flex flex-col bg-white">
        ...
        <div className="flex-1 overflow-hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            <TabsList className="w-full justify-start px-4 py-2 flex-shrink-0">
              <TabsTrigger value="conversation" className="flex items-center gap-2 text-xs">
              ...
              <TabsTrigger value="actions" className="flex items-center gap-2 text-xs">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <TabsContent value="actions" className="h-full m-0 p-4 overflow-y-auto space-y-4">
                <WorkspaceActions
                  ticket={ticket}
                  onTicketUpdate={handleTicketUpdate}
                />
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="hidden xl:block w-80 border-l bg-gray-50 overflow-y-auto flex-shrink-0">
